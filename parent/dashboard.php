      ...
      <header class="bg-white border-b border-slate-200 shadow-sm sticky top-0 z-30">
        <div class="flex items-center justify-between px-6 py-4">
          ...
          <div class="relative" id="parent-dropdown-container">
            ...
            <div id="parent-dropdown-menu" class="hidden absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-slate-200 py-2 z-50 overflow-hidden">
          ...
          <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div>
                ...
                <ul class="space-y-1.5 text-xs text-slate-700">
                  <li class="flex items-center space-x-2"><i data-lucide="mail" class="w-3.5 h-3.5 text-[#E5097F]"></i><span>parent.grievance@rajagiri.edu</span></li>
