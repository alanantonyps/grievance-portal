 ...
 *
 * Auth Check : case-insensitive role match against 'PARENT'
 * Data Source: users LEFT JOIN parents
 * Fields     : Name, Address, Email, Contact Number
 *
 * Features:
 *   • Read-only view of parent profile
 *   • Edit button → redirects to parent/edit_profile.php
...
// ---------------------------------------------------------------------------
// 6. FETCH PARENT PROFILE (users JOIN parents)
// ---------------------------------------------------------------------------
$profile = [
...
//    From parent/ the browser URL is  ../uploads/profiles/...
              ...
              <div class="relative px-6 py-12 overflow-hidden">
                ...
                <div class="relative flex flex-col items-center justify-center">
                  ...
                  <div class="mt-2 inline-flex items-center space-x-1.5 bg-white/80 backdrop-blur-sm border border-purple-200 px-3 py-1 rounded-full shadow-sm">
                    <i data-lucide="users" class="w-3.5 h-3.5 text-[#8B1E7E]"></i>
                    <span class="text-xs font-bold text-[#4A154B] uppercase tracking-wider">Parent</span>
                  </div>
                </div>
              </div>
