 ...
 *
 * Handles:
 *   • Auth guard (MANAGEMENT or GRIEVANCE_MEMBER)
 *   • POST processing: verify current password → validate new → update BCRYPT hash
 *   • Auto-redirect to management/dashboard.php after successful password change
...
// ---------------------------------------------------------------------------
// 5. FETCH MEMBER DETAILS (for header chip + avatar + dropdown)
// ---------------------------------------------------------------------------
$memberData = [
...
//   From management/ the browser URL is  ../uploads/profiles/...
// ---------------------------------------------------------------------------
