<?php
/**
 * management/complaint_report.php
 * ---------------------------------------------------------------------------
 * Management / Grievance Member — Complaint Report (Filtered Grievance Report)
...
if ($conn instanceof mysqli) {
    try {
        ...
        error_log('[Complaint Report Member Profile] ' . $ex->getMessage());
    }
}
...
<head>
  ...
  <title>Complaint Report — <?= e($isManagement ? 'Management' : 'Grievance Member') ?> | Rajagiri College Grievance Portal</title>
            ...
            <div class="bg-white border border-slate-200 rounded-t-xl px-6 py-5">
              ...
              <div class="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-xs text-slate-600">
                ...
                <p>
                  ...
                  Type: <?= e($summaryType) ?> · Member: <?= e($summaryMember) ?> · Status: <?= e($summaryStatus) ?>
                </p>
              </div>
            </div>
