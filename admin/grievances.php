 ...
 *
 * Landing page for the Grievance menu with two action cards:
 *   • Complaint Details  → grievance_details.php
 *   • Grievance Type     → grievance_types.php
 * ---------------------------------------------------------------------------
 */
      ...
      <main class="flex-1 px-6 py-8">
        ...
        <div class="max-w-6xl mx-auto mb-12 animate-fade-in-up text-center">
          ...
          <nav class="flex items-center justify-center space-x-2 text-sm text-slate-500">
            ...
            <span class="text-[#E5097F] font-semibold">Grievance</span>
          </nav>
              ...
              <div class="relative p-6 md:p-7 flex items-center gap-5">
                ...
                <div class="relative flex-shrink-0">
                  ...
                  <div class="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-pink-100 via-purple-100 to-pink-50
                    ...
                    <i data-lucide="file-text" class="w-10 h-10 text-[#4A154B]"></i>
                  </div>
                </div>
              ...
              <div class="relative p-6 md:p-7 flex items-center gap-5">
                ...
                <div class="relative flex-shrink-0">
                  ...
                  <div class="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-pink-100 via-purple-100 to-pink-50
                              ...
                              group-hover:scale-110 group-hover:rotate-6
                              transition-transform duration-300">
                    <i data-lucide="list-checks" class="w-10 h-10 text-[#4A154B]"></i>
                  </div>
                </div>
