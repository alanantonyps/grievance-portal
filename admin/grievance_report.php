 ...
 *
 * Landing page for Grievance Reports with four action cards:
 *   • Complaint Report      → complaint_report.php
 *   • Cell Members Report   → cell_members_report.php
 *   • Consolidated Report   → consolidated_report.php
 *   • Summary Report        → summary_report.php
 * ---------------------------------------------------------------------------
 */
...
// ---------------------------------------------------------------------------
// 2. AUTH GUARD (Admin / Management / Teacher access)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// 6. REPORT CARD DEFINITIONS
// ---------------------------------------------------------------------------
$reportCards = [
    [
        'title' => 'Complaint Report',
        'icon'  => 'file-text',
        'href'  => 'complaint_report.php',
    ],
    [
        'title' => 'Cell Members Report',
        'icon'  => 'users',
        'href'  => 'cell_members_report.php',
    ],
    [
        'title' => 'Consolidated Report',
        'icon'  => 'clipboard-list',
        'href'  => 'consolidated_report.php',
    ],
    [
  ...
  <div class="flex min-h-screen flex-1">
    ...
    <div class="flex-1 ml-20 flex flex-col min-h-screen">
      ...
      <main class="flex-1 px-6 py-8">
        ...
        <div class="max-w-6xl mx-auto mb-12 animate-fade-in-up text-center">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <?php foreach ($reportCards as $index => $card): ?>
              <a href="<?= e($card['href']) ?>"
                ...
                <div class="relative p-6 md:p-7 flex items-center gap-5">
                  ...
                  <div class="relative flex-shrink-0">
                    ...
                    <div class="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-pink-100 via-purple-100 to-pink-50
                                flex items-center justify-center
                                ring-1 ring-white/60 shadow-inner
                                group-hover:scale-110 group-hover:rotate-6
                                transition-transform duration-300">
                      <i data-lucide="<?= e($card['icon']) ?>" class="w-10 h-10 text-[#4A154B]"></i>
                    </div>
                  </div>
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <p class="text-sm font-bold text-[#E5097F] group-hover:text-[#C41574] transition-colors
