      ...
      <main class="flex-1 px-6 py-8">
        ...
        <div class="max-w-6xl mx-auto mb-6 animate-fade-in-up">
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div>
              <h1 class="text-2xl md:text-3xl font-bold text-slate-800 mb-2 tracking-tight">Designation</h1>
                  ...
                  <?php else: ?>
                    ...
                    <?php foreach ($designations as $index => $designation): ?>
                      ...
                      <tr class="hover:bg-slate-50/80 transition-colors group">
                        ...
                        <td class="px-6 py-4 text-sm font-semibold text-slate-800"><?= e($designationName) ?></td>
  ...
  <div id="designationModal" class="hidden fixed inset-0 z-[60] flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl animate-modal-in overflow-hidden">
      ...
      <form id="designationForm" method="POST" action="designations.php" class="p-6 space-y-5">
        ...
        <div class="space-y-2">
          <label for="designation_name" class="block text-sm font-semibold text-slate-700">Designation Name <span class="text-[#E5097F]">*</span></label>
        ...
        <div class="space-y-2">
          <label for="post_occupied" class="block text-sm font-semibold text-slate-700">Post Occupied <span class="text-[#E5097F]">*</span></label>
    ...
    <div id="deleteConfirmPanel"
      ...
      <div class="px-6 pt-6 pb-2 flex flex-col items-center text-center">
        ...
        <p class="text-sm text-slate-500 leading-relaxed">
          ...
          <span id="deleteDesignationNameDisplay" class="font-bold text-[#8B1E7E] break-words">this designation</span>.
        </p>
    ...
    <div id="toggleConfirmPanel"
      ...
      <div class="px-6 pt-6 pb-2 flex flex-col items-center text-center">
        <div id="toggleIconWrapper"
             class="w-16 h-16 rounded-full flex items-center justify-center mb-4 bg-gradient-to-br from-purple-100 to-pink-100 ring-4 ring-purple-50">
        ...
        <p id="toggleModalDescription" class="text-sm text-slate-500 leading-relaxed">
          The status of
          <span id="toggleDesignationNameDisplay" class="font-bold text-[#8B1E7E] break-words">this designation</span>
          will be changed.
        </p>
      </div>
      ...
      window.confirmToggleStatus = function (designationId, designationName, currentStatus) {
        ...
        if (isCurrentlyActive) {
          ...
          if (toggleModalDescription) {
            toggleModalDescription.innerHTML = 'The designation <span class="font-bold text-[#8B1E7E] break-words">"' + designationName + '"</span> will be marked as <span class="font-bold text-[#8B1E7E]">Inactive</span>.';
          }
          ...
          if (toggleModalDescription) {
            toggleModalDescription.innerHTML = 'The designation <span class="font-bold text-[#8B1E7E] break-words">"' + designationName + '"</span> will be marked as <span class="font-bold text-[#8B1E7E]">Active</span>.';
          }
