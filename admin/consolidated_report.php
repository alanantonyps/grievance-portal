...
// Detect whether the form has been submitted
...
<head>
  ...
  <title>Consolidated Report — Admin | Rajagiri College Grievance Portal</title>
      ...
      <main class="flex-1 px-6 py-8">
          ...
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div>
              ...
              <nav class="flex items-center space-x-2 text-sm text-slate-500">
                ...
                <span class="text-slate-300">/</span>
                <span class="text-[#E5097F] font-semibold">Redressal Report</span>
              </nav>
            </div>
        ...
        <div class="max-w-6xl mx-auto mb-6 animate-fade-in-up no-print" style="animation-delay: 60ms;">
          <div class="bg-slate-100 border border-slate-200 rounded-xl px-6 py-6 shadow-sm">
            ...
            <form method="GET" action="consolidated_report.php" class="space-y-5">
        ...
        <!-- ============================================================
             ...
             Only rendered when the form has been submitted.
             ============================================================ -->
        <?php if ($reportSubmitted): ?>
          <div id="reportSection" class="max-w-6xl mx-auto animate-fade-in-up" style="animation-delay: 120ms;">
            ...
            <div class="bg-white border border-slate-200 rounded-t-xl px-6 py-5">
              ...
              <h2 class="text-xl md:text-2xl font-bold text-slate-800 mt-5 tracking-tight">Consolidated Report</h2>
                ...
                <table class="w-full report-table">
                  <thead>
                    <tr class="bg-[#4A154B] text-white">
                      ...
                      <th class="px-4 py-3 text-right text-xs font-bold uppercase tracking-wider" style="width: 140px;">No</th>
                    </tr>
                  </thead>
                  <tbody class="divide-y divide-slate-100 bg-white">
                    ...
                    <?php foreach ($reportRows as $i => $row): ?>
                      <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="px-4 py-3 text-sm text-slate-800"><?= e($row['label']) ?></td>
                        <td class="px-4 py-3 text-sm text-slate-800 text-right font-semibold"><?= (int) $row['count'] ?></td>
                      </tr>
                    <?php endforeach; ?>
