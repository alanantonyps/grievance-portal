 ...
 *
 * Features:
 *   • Filter by date range, grievance type, member, course, class, dept,
...
<head>
  ...
  <!-- ============================================================
       PRINT-ONLY STYLES
       Hides everything except the report section when printing.
       ============================================================ -->
  <style>
    @media print {
          ...
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div>
              ...
              <nav class="flex items-center space-x-2 text-sm text-slate-500">
                ...
                <a href="grievance_reports.php" class="hover:text-[#8B1E7E] transition-colors">
                  Grievance Reports
                </a>
                <span class="text-slate-300">/</span>
