...
$sidebarMenu = [
    [
        ...
        'title'         => 'Settings',
        'icon'          => 'settings',
        'landing_href'  => 'settings.php',     // ← clicked when sidebar is collapsed
        'items'         => [
  ...
  <div class="flex min-h-screen flex-1">
    ...
    <aside id="adminSidebar"
      ...
      <button id="sidebarToggle"
              class="text-white/80 hover:text-white mb-10 p-2 rounded-lg hover:bg-white/10 transition-colors
                     flex items-center justify-center w-14 mx-auto flex-shrink-0" aria-label="Toggle sidebar">
        <i data-lucide="menu" class="w-6 h-6 flex-shrink-0"></i>
      </button>

      <!-- Scrollable nav -->
      <nav id="sidebarNav" class="flex flex-col space-y-1 flex-1 w-full px-3 pt-2 overflow-y-auto overflow-x-hidden
                                  [scrollbar-width:thin] [scrollbar-color:rgba(255,255,255,0.2)_transparent]">

        <!-- Dashboard (main) -->
        <a href="dashboard.php"
           class="group relative w-full h-12 rounded-xl bg-white/20 backdrop-blur-sm flex items-center text-white shadow-lg ring-2 ring-white/30 transition-all hover:bg-white/30 px-3 flex-shrink-0">
        ...
        <?php foreach ($sidebarMenu as $section): ?>
          <div class="sidebar-group flex-shrink-0" data-section="<?= e($section['id']) ?>">
            ...
            <!-- Parent button (toggles submenu OR navigates when collapsed) -->
            <button type="button"
                    data-submenu-toggle="<?= e($section['id']) ?>"
                    data-landing-href="<?= e($section['landing_href']) ?>"
                    class="group relative w-full h-12 rounded-xl bg-white/10 hover:bg-white/20 flex items-center text-white transition-all px-3">
              ...
              <span class="sidebar-tooltip absolute left-full ml-3 hidden group-hover:block whitespace-nowrap bg-[#4A154B] text-white text-xs px-3 py-1.5 rounded-lg shadow-lg z-50">
                <?= e($section['title']) ?>
              </span>
            </button>
        ...
        <!-- My Profile (main) -->
        <a href="profile.php"
           class="group relative w-full h-12 rounded-xl bg-white/10 hover:bg-white/20 flex items-center text-white transition-all px-3 flex-shrink-0">
      ...
      <a href="#" data-logout-trigger="1" id="sidebarLogoutBtn"
         class="group relative w-full h-12 rounded-xl bg-white/10 hover:bg-red-500/40 flex items-center text-white transition-all mx-3 px-3 flex-shrink-0"
        ...
        <div class="flex items-center justify-between px-6 py-4">
          ...
          <div class="relative" id="admin-dropdown-container">
            ...
            <div id="admin-dropdown-menu"
              ...
              <a href="dashboard.php" class="flex items-center px-4 py-2.5 text-sm text-slate-700 hover:bg-gradient-to-r hover:from-pink-50 hover:to-purple-50 hover:text-[#8B1E7E] transition-all duration-200 group">
                <i data-lucide="layout-dashboard" class="w-4 h-4 mr-3 text-[#8B1E7E] group-hover:scale-110 transition-transform"></i>
              ...
              <a href="profile.php" class="flex items-center px-4 py-2.5 text-sm text-slate-700 hover:bg-gradient-to-r hover:from-pink-50 hover:to-purple-50 hover:text-[#8B1E7E] transition-all duration-200 group">
                <i data-lucide="user" class="w-4 h-4 mr-3 text-[#8B1E7E] group-hover:scale-110 transition-transform"></i>
                <span class="font-medium">My Profile</span>
                <i data-lucide="arrow-right" class="w-4 h-4 ml-auto opacity-0 group-hover:opacity-100 text-[#8B1E7E] transition-opacity"></i>
              </a>

              <a href="change_password.php" class="flex items-center px-4 py-2.5 text-sm text-slate-700 hover:bg-gradient-to-r hover:from-pink-50 hover:to-purple-50 hover:text-[#8B1E7E] transition-all duration-200 group">
      ...
      <main class="flex-1 px-6 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-5xl mx-auto mb-12">
          ...
          <div class="flex items-center space-x-4 bg-white rounded-full shadow-lg border border-slate-100 p-3 pr-6 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
            ...
            <div>
              <span class="block text-2xl md:text-3xl font-extrabold text-[#4A154B]"><?= (int) $totalGrievances ?></span>
              <span class="block text-sm md:text-base font-semibold text-[#4A154B]">Total Grievance</span>
            </div>
          </div>
          ...
          <div class="flex items-center space-x-4 bg-white rounded-full shadow-lg border border-slate-100 p-3 pr-6 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
            ...
            <div>
              <span class="block text-2xl md:text-3xl font-extrabold text-[#4A154B]"><?= (int) $pendingGrievances ?></span>
              <span class="block text-sm md:text-base font-semibold text-[#4A154B]">Pending Grievance</span>
            </div>
          </div>
          ...
          <div class="flex items-center space-x-4 bg-white rounded-full shadow-lg border border-slate-100 p-3 pr-6 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
            ...
            <div>
              <span class="block text-2xl md:text-3xl font-extrabold text-[#4A154B]"><?= (int) $closedGrievances ?></span>
              <span class="block text-sm md:text-base font-semibold text-[#4A154B]">Closed Grievance</span>
            </div>
          </div>
      ...
      (function () {
        ...
        toggleBtn.addEventListener('click', function () {
          ...
          if (expanded) {
            ...
            // Collapse all submenus when hiding sidebar
      ...
      (function () {
        ...
        toggles.forEach(function (btn) {
          btn.addEventListener('click', function (e) {
            ...
            // COLLAPSED → navigate to the section's landing page
            if (isCollapsed) {
