...
// ---------------------------------------------------------------------------
// 10. FETCH STUDENT'S GRIEVANCES (with type join)
// ---------------------------------------------------------------------------
$grievances = [];
  ...
  <div class="flex min-h-screen flex-1">
    ...
    <div id="studentMain" class="flex-1 ml-20 flex flex-col min-h-screen transition-all duration-300">
      ...
      <main class="flex-1 px-6 py-8">
        ...
        <!-- DATA TABLE (fits viewport, no horizontal scroll) -->
          ...
          <div class="bg-white rounded-2xl shadow-lg border border-slate-200/70 overflow-hidden">
            ...
            <table class="w-full table-fixed" id="grievancesTable">
              <colgroup>
                ...
                <col style="width: 13%;">  <!-- Grievance Number -->
                <col style="width: 13%;">  <!-- Grievance Type -->
                <col style="width: 9%;">   <!-- Date -->
                <col style="width: 20%;">  <!-- Subject -->
                <col style="width: 9%;">   <!-- Status -->
                <col style="width: 12%;">  <!-- Actions -->
                <col style="width: 20%;">  <!-- Remainder / Reopen -->
              </colgroup>
              <thead>
